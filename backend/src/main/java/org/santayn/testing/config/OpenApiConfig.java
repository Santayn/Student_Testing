...
public class OpenApiConfig {
    ...
    private static Map<OperationKey, OperationDoc> operationDocs() {
        ...
        put(docs, "GET", "/api/v1/public/learning/tests/{testId}", "Публичное обучение", "Загрузить публичный тест",
        ...
        put(docs, "POST", "/api/v1/public/learning/tests/{testId}/submit", "Публичное обучение", "Отправить ответы по тесту",
