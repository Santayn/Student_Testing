...
6. **A14 / рекомендация 17** — запретить несколько активных учебных групп одного студента и определить атомарный перевод.
7. **A8** — атомарная rotation refresh-token.
8. **Рекомендации 8–10** — активность и lifecycle SubjectMembership.
9. **Рекомендация 12** — убрать mutation из student GET.
10. **Рекомендация 13** — score-based results.
11. Затем A9–A13 и архитектурные пункты 1, 6, 11, 14, 15, 16.
